...
\begin{enumerate}
    \item Chat Generator (\texttt{chat.py}): The code is overall divided into some sections (logical blocks) as follows:
    \begin{itemize}
